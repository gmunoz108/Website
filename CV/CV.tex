...
\rhead{}
\lfoot{}
\cfoot{\scriptsize  Gerardo Munoz - CV - \apstylekinda\today}
...
\hypersetup{unicode=true,
            pdftitle={Gerardo Munoz:  CV (Curriculum Vitae)},
            pdfauthor={Gerardo Munoz},
            colorlinks=true,
            linkcolor=blue,
            citecolor=blue,
            urlcolor=blue,
...
\centerline{\huge \bf Gerardo Munoz}
...
NW10 7RR, UK}
\moveleft.5\hoffset\centerline{ \faEnvelope \hspace{1 mm} \href{mailto:}{\tt gmunoz108@g.ucla.edu} \hspace{1 mm}  \faPhone \hspace{1 mm}  123-456-7890  \hspace{1 mm}       \faGlobe \hspace{1 mm} \href{http://quarto.org}{\tt quarto.org}      }
